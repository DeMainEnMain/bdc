        ...
        return (
            <div className="panel panel-info">
                <div className="panel-heading">
                    <h3 className="panel-title">{__("Stock de billets — T!nda disponibles pour le change")}</h3>
                </div>
            ...
            <div className="panel panel-info">
                ...
                <div className="panel-body">
                    ...
                    <div className="row margin-top">
                        ...
                        <div className="col-md-offset-2 col-md-2 col-sm-4">
                            <a href="/manager/cash-deposit" data-eusko="cash-deposit" className="btn btn-default">{__("Remise de monnaie à De Main en Main")}</a>
                        </div>
                    </div>
                </div>
            </div>
